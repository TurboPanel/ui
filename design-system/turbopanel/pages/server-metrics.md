...
- **Collapsible groups:** CPU, Memory, Storage, Network (host-scoped) — followed by whichever presence-gated entity groups this server actually has (GPU, Additional network devices, Filesystems, Block devices, Physical signals, Ingress, Database proxy). All groups start expanded for now.
