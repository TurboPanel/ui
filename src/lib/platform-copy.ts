...
export const HA_METRICS_LOCAL_NOTE =
  'Local dev does not emulate TurboPanel High Availability metrics storage. Use self-hosted mode (ClickHouse) for local charts, or configure analytics on your TurboPanel High Availability deployment.' as const
